...
const isBound = (grid, newRow, newCol) => {
...
const getChildren = (grid, row, col, startColor) => {
    ...
    for (const direction of directions) {
        ...
        const isInBound = isBound(grid, newRow, newCol);
...
const floodFill = (image, startRow, startCol, color) => {
...
console.log(`Your answer: ${floodFill(image, sr, sc, color)}`);
console.log(
    `Correct answer: ${[
        [
            [
